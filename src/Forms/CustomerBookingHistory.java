...
public class CustomerBookingHistory extends CommonFunctionality {
     ...
     */
    public static void main(Customer aLoggedInCustomer) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerBookingHistory.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerBookingHistory(aLoggedInCustomer).setVisible(true);
            }
        });
    }
